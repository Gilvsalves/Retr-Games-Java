	...
	public AnimacaoTela() {
		tela = new JPanel() {
			...
			public void paintComponent (Graphics g) {
				// Limpar desenhos anteriores(pinta a tela de branco):
				g.setColor(Color.WHITE); //Rect == retangulo
				g.fillRect(0,0, tela.getWidth(), tela.getHeight());// x, y, width, height
				//-------------------------------------------------//
